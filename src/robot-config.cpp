...
motor ArmMotorB = motor(PORT8, ratio18_1, false);
motor_group Arm = motor_group(ArmMotorA, ArmMotorB);
/*vex-vision-config:begin*/
vision Eyeball = vision (PORT21, 50);
/*vex-vision-config:end*/
motor ForkMotorA = motor(PORT15, ratio18_1, true);
motor ForkMotorB = motor(PORT16, ratio18_1, false);
motor_group Fork = motor_group(ForkMotorA, ForkMotorB);
digital_out StickyPiston = digital_out(Brain.ThreeWirePort.A);
